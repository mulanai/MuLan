...
class MVDreamPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        prompt_embeds_pos, prompt_embeds_neg = self.encode_prompt(
            prompt=prompt,
            device=device,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                encoder_hidden_states = torch.cat([prompt_embeds_neg] * actual_num_frames + [prompt_embeds_pos] * actual_num_frames)
                unet_inputs = {
                ...
                noise_pred = self.unet.forward(sample, timesteps, encoder_hidden_states, **unet_inputs)
